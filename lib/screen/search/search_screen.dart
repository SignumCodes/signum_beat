...
class _SearchScreenState extends State<SearchScreen> {
  ...
  _buildTopSearch(searchProvider, playSongProvider) {
    return GridView.builder(
        ...
        itemCount: searchProvider.topSearchResponse.length,
            ...
            onTap: () async {
              if (item.type == 'album') {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => AlbumDetails(albumId: item.id)));
              }
              if (item.type == 'song') {
        ...
        children: [
          ...
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemCount:
                  searchProvider.autoComplete.first.topQuery.results.length,
              itemBuilder: (context, index) {
                var topResult =
                    searchProvider.autoComplete.first.topQuery.results;
                ...
                return data.type == 'song'
                    ? CustomCard(
                        ...
                        leading: Image(
                          image: NetworkImage(data.image!.last.link.toString()),
                        ),
                        onTap: () async {
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              var album =
                  searchProvider.autoComplete.first.albums.results[index];
              return CustomTile(
                ...
                type: album.type,
                image: album.image!.last.link.toString().startsWith('http')
          ...
          SizedBox(
            ...
            child: ListView.builder(
              scrollDirection: Axis.horizontal,
              itemCount:
                  searchProvider.autoComplete.first.artists.results.length,
              itemBuilder: (context, index) {
                var topResult =
