...
PlaylistResponse _$PlaylistResponseFromJson(Map<String, dynamic> json) =>
    PlaylistResponse(
      id: json['listid']??json['id']??json['details']['listid']??'',
      userId: json['uid'] ,
      name: json['listname']??json['title']??json['details']['listname']??'',
      songCount: json['list_count'],
      ...
      //     .map((e) => DownloadLink.fromJson(e as Map<String, dynamic>))
      //     .toList(),
      image: json['image'] ?? json['details']['image'] ,
      url: json['perma_url'] ,
